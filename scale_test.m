...
testimgPath1 = dir('C:\Users\Jahnavi Chowdary\Desktop\IIIT\3rd Year\DIP\Project\scale_test\*.jpg');
hstgrm = [];
fullset_image_ftr = [];
vocab_size = 7000;
...
for num = 1:length(testimgPath1)
    ...
    full_file_name = fullfile('C:\Users\Jahnavi Chowdary\Desktop\IIIT\3rd Year\DIP\Project\scale_test',file_name);
