...
testimgPath1 = dir('C:\Users\Jahnavi Chowdary\Desktop\IIIT\3rd Year\DIP\Project\Dataset_Small\query_sketch\*.jpg');
vocab_size = 2000;
...
for num = 1
    ...
    full_file_name = fullfile('C:\Users\Jahnavi Chowdary\Desktop\IIIT\3rd Year\DIP\Project\Dataset_Small\query_sketch',file_name);
...
for num = 1:length(id)
    ...
    full_file_name2 = fullfile('C:\Users\Jahnavi Chowdary\Desktop\IIIT\3rd Year\DIP\Project\Dataset_Small\flickr_images\images\All Train\output',file_name1);
