...
%% Training
tic;
testimgPath1 = dir('C:\Users\Jahnavi Chowdary\Desktop\IIIT\3rd Year\DIP\Project\Dataset_Small\flickr_images\images\All Train\*.jpg');
hstgrm = [];
fullset_image_ftr = [];
...
for num = 1:length(testimgPath1)
    ...
    full_file_name = fullfile('C:\Users\Jahnavi Chowdary\Desktop\IIIT\3rd Year\DIP\Project\Dataset_Small\flickr_images\images\All Train',file_name);
